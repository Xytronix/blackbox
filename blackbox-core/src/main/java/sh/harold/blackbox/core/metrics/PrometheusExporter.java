...
public final class PrometheusExporter implements AutoCloseable {
    ...
    public static String render(HealthGauges gauges) {
        ...
        pluginMetrics(sb, gauges.pluginGauges(), "blackbox_plugin_gauge", "gauge");
        pluginMetrics(sb, gauges.pluginCounters(), "blackbox_plugin_counter", "counter");
    ...
    private static void pluginMetrics(StringBuilder sb, Map<String, Double> metrics, String name, String type) {
        boolean typed = false;
